        ...
        <div class="stat-box" 
            ...
            <div class="stat-top">
                <div class="stat-title">
                    <?php 
                        // Change the label based on completion status
                        echo $isCompleted ? "Hints Used" : "Available Hints"; 
                    ?>
                </div>
                ...
                <div class="stat-value">
                    <span id="hintCount">
                        <?php 
                        if ($isCompleted) {
                            // Show how many they actually used
                            echo (int)$used_hints;
                        } else {
                            // Show the total potential hints they have
        ...
        <div class="nav-controls">
            ...
            <?php if ($game_status == 'completed'): ?>
                ...
                <div class="arrow-nav" id="arrowNav">
                    ...
                    <div class="arrow-btn right" onclick="goNext()">NEXT</div>
...
function hintInfo(hints){
    ...
    window.location.href = 'byteguess_hint_demo.php?game_id=' + GAME_ID;
...
function openCard(data) {
    ...
    if(data.cu_treasure_image !== null){
         ...
         // Fill the modal with data from the PHP json_encode

       body.innerHTML = `

            <img src="card/unit/${data.cu_treasure_image}"
        ...
        body.innerHTML = `<div class="split-guideline-wrapper">
